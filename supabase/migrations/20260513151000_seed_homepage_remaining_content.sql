...
SET
  ...
  restaurant_home_headline_primary = COALESCE(NULLIF(restaurant_home_headline_primary, ''), 'Curated Dining.'),
  restaurant_home_headline_accent = COALESCE(NULLIF(restaurant_home_headline_accent, ''), 'Refined Pause.'),
  restaurant_highlight_text = COALESCE(NULLIF(restaurant_highlight_text, ''), 'Where local harvests meet global mastery. Every dish is a narrative of freshness and quality downtime.'),
