...
export const aboutContentTextSchema = z.object({
  ...
  owner_section_kicker: z.string().trim().max(120),
  owner_section_title: z.string().trim().max(240),
  owner_name: z.string().trim().max(160),
  owner_role: z.string().trim().max(200),
  owner_body: z.string().trim().max(4000),
  hero_image_alt: z.string().trim().max(500).optional(),
  story_image_alt: z.string().trim().max(500).optional(),
  owner_image_alt: z.string().trim().max(500).optional(),
