...
export const homepageContentFormSchema = z
  .object({
    ...
    about_preview_kicker: z.string().trim().max(120),
    about_preview_headline: z.string().trim().max(320),
    about_preview_eyebrow: z.string().trim().max(120),
    about_preview_text: z.string().trim().max(4000),
    about_preview_why_title: z.string().trim().max(120),
    about_preview_why_text: z.string().trim().max(1200),
    about_preview_button_label: z.string().trim().max(120),
    about_preview_button_href: href,
    restaurant_highlight_text: z.string().trim().max(4000),
    carwash_intro_text: z.string().trim().max(4000),
    playground_intro_text: z.string().trim().max(4000),
    mini_market_intro_text: z.string().trim().max(4000),
    hero_image_alt: alt,
    about_preview_image_alt: alt,
    ...
    restaurant_home_headline_primary: z.string().trim().max(320),
